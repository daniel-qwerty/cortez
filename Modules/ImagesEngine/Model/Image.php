...
class ImagesEngine_Model_Image extends Com_Module_Model {

    /**
     *
     * @return ImagesEngine_Model_Image 
     */
    ...
    public function getList() {
     ...
     public function getListByLan($lanId) {
        $text = new Entities_ImagesEngine();
        return $text->getAll($text->getList()->where("ImgLanId={$lanId} and ImgStatus = 1"));
    }
