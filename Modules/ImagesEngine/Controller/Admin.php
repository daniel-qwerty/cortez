...
class ImagesEngine_Controller_Admin extends Admin_Controller_Admin {

    public function init() {
        parent::init();
        Com_Helper_Title::getInstance()->title = "M&oacute;dulo Imagenes";
        Com_Helper_BreadCrumbs::getInstance()->add("Imagenes", "/Admin/ImagesEngine");
    }

    public function Add() {
        Com_Helper_BreadCrumbs::getInstance()->add("Item", "/Admin/ImagesEngine/Add");
        ...
        if ($this->isPost()) {
            ...
            $id = ImagesEngine_Model_Image::getInstance()->doInsert($this->getPostObject(), $languages, $imageFile);
            $this->redirect(Com_Helper_Url::getInstance()->urlBase . '/Admin/ImagesEngine/Edit/id/' . $id);
        }
        $this->assign('Alias');
    ...
    public function Edit() {
        ...
        if ($this->isPost()) {
            ...
            ImagesEngine_Model_Image::getInstance()->doUpdate(get('id'), $this->getPostObject(), $imageFile);
            $this->redirect(Com_Helper_Url::getInstance()->urlBase . '/Admin/ImagesEngine/Edit/lan/' . $language . '/id/' . get('id'));
        }

        $entity = ImagesEngine_Model_Image::getInstance()->get(get('id'), $language);
    ...
    public function Delete() {
        ImagesEngine_Model_Image::getInstance()->doDelete(get('id'));
        $this->redirect(Com_Helper_Url::getInstance()->urlBase . '/Admin/ImagesEngine');
    }
